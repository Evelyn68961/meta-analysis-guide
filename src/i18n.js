...
const translations = {
  zh: {
    ...
    c1q1: "以下哪個是正確的 PICO 格式研究問題？",
    c1q1a: "糖尿病藥物有效嗎？", c1q1b: "在第二型糖尿病成人中，Metformin 相比安慰劑能否降低 HbA1c？", c1q1c: "Metformin 是最好的藥嗎？", c1q1d: "糖尿病患者應該吃什麼藥？",
    c1q1correct: 1, c1q1exp: "選項 B 清楚包含了 P（第二型糖尿病成人）、I（Metformin）、C（安慰劑）和 O（HbA1c 降低），是標準的 PICO 格式。",
    c1q2: "在 PICO 中，「C」代表什麼？為什麼它很重要？",
    c1q2a: "Conclusion（結論）— 統合分析的最終結果", c1q2b: "Comparison（對照組）— 沒有對照就無法判斷因果關係", c1q2c: "Category（分類）— 用來分類不同的研究", c1q2d: "Criteria（標準）— 納入研究的條件",
    c1q2correct: 1, c1q2exp: "C 是 Comparison（對照組），它是因果推論的核心。沒有明確的對照組，你無法判斷介入措施的效果是真實的還是自然發生的。",
    c1q3: "你正在研究「延長輸注 β-lactam 抗生素對重症患者的效果」。以下哪個 Population 定義最恰當？",
    c1q3a: "所有接受抗生素的患者", c1q3b: "加護病房中接受 β-lactam 抗生素治療的重症成人患者", c1q3c: "住院的患者", c1q3d: "有感染症狀的人",
    c1q3correct: 1, c1q3exp: "選項 B 精確定義了族群：場域（ICU）、藥物類別（β-lactam）、嚴重度（重症）和年齡（成人）。其他選項太廣泛，會納入不相關的研究。",
    c1q4: "PICOS 中的 S 代表什麼？什麼時候需要加上它？",
    c1q4a: "Sample size（樣本量）— 當你想限制研究大小時", c1q4b: "Study design（研究設計）— 當你想限定納入的研究類型時", c1q4c: "Statistics（統計方法）— 當你想指定分析方法時", c1q4d: "Setting（場域）— 當你想限制研究地點時",
    c1q4correct: 1, c1q4exp: "S 是 Study design（研究設計）。加上 S 可以幫你限定只看 RCT、或只看世代研究等。這在你預先知道要做何種等級的證據綜合時特別重要。",
    c1q5: "以下哪個是 PICO 的常見錯誤？",
    c1q5a: "在 Outcome 中指定具體的量測工具和時間點", c1q5b: "先做初步搜尋確認有足夠的研究再確定 PICO", c1q5c: "把 Population 定義為「所有患者」而不限定具體特徵", c1q5d: "在 Comparison 中同時考慮安慰劑和積極對照組",
    c1q5correct: 2, c1q5exp: "把族群定義為「所有患者」太過廣泛，會讓搜尋結果過多且不聚焦。好的 P 應該限定年齡、疾病階段、嚴重度等特徵。其他選項都是好的做法。",
    c1q6: "你想研究「SGLT2 抑制劑對心衰竭患者的效果」。以下哪個 Outcome 定義最合適？",
    c1q6a: "病人有沒有好轉", c1q6b: "心血管死亡或心衰竭住院的複合終點", c1q6c: "所有不良事件", c1q6d: "醫生的主觀評估",
    c1q6correct: 1, c1q6exp: "選項 B 是一個具體、可量測的複合終點，常用於心衰竭臨床試驗（如 DAPA-HF, EMPEROR-Reduced）。其他選項太主觀或太廣泛，無法精確量化。",
  ...
  en: {
    ...
    c1q1: "Which is a properly formatted PICO research question?",
    c1q1a: "Do diabetes drugs work?", c1q1b: "In adults with T2DM, does Metformin vs placebo reduce HbA1c?", c1q1c: "Is Metformin the best drug?", c1q1d: "What should diabetes patients take?",
    c1q1correct: 1, c1q1exp: "Option B clearly contains P (adults with T2DM), I (Metformin), C (placebo), and O (HbA1c reduction) — a standard PICO format.",
    c1q2: "What does 'C' in PICO stand for, and why is it important?",
    c1q2a: "Conclusion — the final result", c1q2b: "Comparison — without it, you can't establish causation", c1q2c: "Category — used to classify studies", c1q2d: "Criteria — conditions for inclusion",
    c1q2correct: 1, c1q2exp: "C stands for Comparison. It's the core of causal inference. Without a comparator, you can't tell if the effect is real or natural.",
    c1q3: "For 'prolonged β-lactam infusion in critically ill patients,' which Population is most appropriate?",
    c1q3a: "All patients receiving antibiotics", c1q3b: "Critically ill adults in ICU receiving β-lactam antibiotics", c1q3c: "Hospitalized patients", c1q3d: "People with infection symptoms",
    c1q3correct: 1, c1q3exp: "Option B precisely defines setting (ICU), drug class (β-lactam), severity (critically ill), and age (adults). Others are too broad.",
    c1q4: "What does S in PICOS stand for?",
    c1q4a: "Sample size", c1q4b: "Study design — to specify which study types to include", c1q4c: "Statistics", c1q4d: "Setting",
    c1q4correct: 1, c1q4exp: "S = Study design. It lets you restrict to RCTs only, cohort studies, etc.",
    c1q5: "Which is a common PICO mistake?",
    c1q5a: "Specifying a concrete measurement tool in Outcome", c1q5b: "Doing a preliminary search before finalizing PICO", c1q5c: "Defining Population as 'all patients' without specifics", c1q5d: "Considering both placebo and active comparators",
    c1q5correct: 2, c1q5exp: "'All patients' is too broad. A good P should specify age, disease stage, severity.",
    c1q6: "For 'SGLT2 inhibitors for heart failure,' which Outcome is most appropriate?",
    c1q6a: "Whether patients got better", c1q6b: "Composite of CV death or HF hospitalization", c1q6c: "All adverse events", c1q6d: "Physician's subjective assessment",
    c1q6correct: 1, c1q6exp: "Option B is a specific, measurable composite endpoint used in major HF trials (DAPA-HF, EMPEROR-Reduced).",
