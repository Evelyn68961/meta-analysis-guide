...
const translations = {
  zh: {
    ...
    c1s4Label: "互動練習",
    c1s4Title: "打造你自己的 PICO",
    c1s4Intro: "試試看！選擇一個臨床情境，然後填入 PICO 的每個元素。這個練習會幫你把抽象概念變成實際操作。",
    c1s4Scenario: "選擇情境：",
    ...
    c1gameDesc: "回答 7 道關於 PICO 的問題。全部答對，龍蛋就會孵化出可愛的小恐龍！但如果答錯 3 題以上，龍蛋會被凍住……",
    c1gameStart: "開始孵化 🥚",
  ...
  en: {
    ...
    c1s3Next: "Let's practice! →",

    c1s4Label: "Interactive Exercise", c1s4Title: "Build Your Own PICO",
    c1s4Intro: "Try it yourself! Pick a clinical scenario and fill in each PICO element.",
    c1s4Scenario: "Choose a scenario:",
    ...
    c1s4Next: "Ready? Let's check common mistakes first →",
    ...
    c1gameDesc: "Answer 7 PICO questions. Get all correct and the eggs hatch into adorable dinosaurs! But get 3+ wrong and they freeze solid…",
