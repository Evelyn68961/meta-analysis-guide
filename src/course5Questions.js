...
export const course5Questions = [
  ...
  // ════════════════════════════════════════════════════════════
  // NEW ADVANCED QUESTIONS (c5-071 to c5-105): 35 questions
  // Types: true_false, multi_select, ordering, spot_error
  // 5 per category (categories 0-6)
  // ════════════════════════════════════════════════════════════

  {
    id: "c5-071", category: 0, type: "true_false",
    zh: { q: "「異質性只在使用隨機效應模型時才需要評估。」", exp: "錯誤。不論用哪種模型，都應該評估異質性。即使用固定效應，異質性也會影響結果的可推廣性。" },
    en: { q: "'Heterogeneity only needs to be assessed when using a random-effects model.'", exp: "False. Heterogeneity should be assessed regardless of model choice. Even under fixed-effect, heterogeneity affects generalizability." },
    correct: false
  },
  {
  ...
  {
    id: "c5-073", category: 0, type: "multi_select",
    zh: { q: "異質性可能導致的後果？（選出所有正確答案）", opts: ["合併效應量可能不具代表性", "需要探索不一致的原因", "信賴區間可能被低估（若忽略）", "讓統合分析完全無效"], exp: "高異質性使合併效應代表性降低、需要探索原因、可能低估 CI。但不會讓統合分析完全無效。" },
    en: { q: "Consequences of heterogeneity? (Select ALL correct)", opts: ["Pooled effect may not be representative", "Need to explore why studies differ", "CI may be underestimated if ignored", "Makes meta-analysis completely invalid"], exp: "High heterogeneity makes pooled effects less representative, requires exploration, may lead to underestimated CIs. But doesn't make meta-analysis invalid." },
    correctAll: [0, 1, 2]
  },
  {
    id: "c5-074", category: 0, type: "spot_error",
    zh: {
      q: "找出以下異質性描述中的錯誤：",
      statements: [
        "異質性指研究間效應量的差異程度。",
    ...
    en: {
      q: "Find the error in these heterogeneity statements:",
      statements: [
        "Heterogeneity refers to variation in effect sizes across studies.",
        "All meta-analyses should assess heterogeneity.",
        "I² = 0% definitely means absolutely no heterogeneity.",
        "High heterogeneity warrants exploration (e.g., subgroup analysis)."
      ],
      exp: "I² = 0% doesn't definitively mean no heterogeneity. With few studies, I² may be imprecise — 0% could reflect lack of detection rather than true absence."
    },
    correct: 2
  },
  {
    id: "c5-075", category: 0, type: "ordering",
    zh: {
      q: "將以下異質性程度從低到高排列：",
      items: ["所有研究效應方向一致、CI 大量重疊", "效應方向一致但少數研究偏離較大", "效應方向混合，有些正有些負", "效應量差異極大且方向完全相反"],
      exp: "CI 大量重疊（低）→ 少數偏離（中低）→ 方向混合（中高）→ 完全相反（高）。差異越大，異質性越高。"
    },
    en: {
      q: "Arrange from lowest to highest heterogeneity:",
      items: ["All effects in same direction, CIs overlap substantially", "Same direction but a few studies deviate notably", "Mixed directions — some positive, some negative", "Widely different magnitudes with opposite directions"],
      exp: "Substantial overlap (low) → few deviations (low-moderate) → mixed directions (moderate-high) → opposite directions (high)."
    },
  ...
  {
    id: "c5-076", category: 1, type: "true_false",
    zh: { q: "「I² 的值不受統合分析中研究數量的直接影響。」", exp: "大致正確。I² 是百分比指標，不像 Q 的 p 值那樣直接受研究數量影響。但少量研究時 I² 的精確度較差。" },
    en: { q: "'I² values are not directly affected by the number of studies.'", exp: "Largely true. I² is a percentage metric not directly influenced by study count, unlike Q's p-value. However, I² precision is poor with few studies." },
    correct: true
  },
  {
    id: "c5-077", category: 1, type: "multi_select",
    zh: { q: "完整報告異質性應包含哪些？（選出所有正確答案）", opts: ["Cochran's Q 統計量及其 p 值", "I² 及其信賴區間", "τ²", "只報告一個就夠了"], exp: "完整報告包括 Q（及 p 值）、I²（及 CI）、τ²。只報告一個是不充分的。" },
    en: { q: "Complete heterogeneity reporting should include? (Select ALL correct)", opts: ["Cochran's Q with p-value", "I² with its confidence interval", "τ²", "Just one of these is enough"], exp: "Complete reporting includes Q (with p-value), I² (with CI), and τ². Reporting only one is insufficient." },
    correctAll: [0, 1, 2]
  },
  {
    id: "c5-078", category: 1, type: "spot_error",
    zh: {
      q: "找出以下 I² 解讀中的錯誤：",
      statements: [
        "I² = 85% 代表高度異質性。",
        "這意味著 85% 的差異來自真實的研究間差異。",
    ...
    en: {
      ...
      statements: [
        "I² = 85% indicates high heterogeneity.",
        "This means 85% of variation is due to real between-study differences.",
        "Q test p < 0.001 further supports the presence of heterogeneity.",
        "High I² means we cannot perform meta-analysis."
      ],
      exp: "High I² does NOT mean meta-analysis is prohibited. You can proceed with random-effects, subgroup analysis, etc. to explore and explain the heterogeneity."
    },
    correct: 3
  },
  {
    id: "c5-079", category: 1, type: "ordering",
    zh: {
      q: "將 I² 值從「最低異質性」到「最高異質性」排列（Cochrane 慣例）：",
      items: ["I² = 75%", "I² = 25%", "I² = 0%", "I² = 50%"],
      exp: "0%（無）→ 25%（低）→ 50%（中）→ 75%（高）。Cochrane 的常用分級標準。"
    },
    en: {
      q: "Arrange I² values from lowest to highest heterogeneity (Cochrane conventions):",
      items: ["I² = 75%", "I² = 25%", "I² = 0%", "I² = 50%"],
      exp: "0% (none) → 25% (low) → 50% (moderate) → 75% (high). Standard Cochrane classification."
    },
    correctOrder: [2, 1, 3, 0]
  },
  {
    id: "c5-080", category: 1, type: "true_false",
    zh: { q: "「預測區間通常比合併效應量的信賴區間更窄。」", exp: "錯誤。預測區間考慮了研究間變異，預測新研究的效應範圍，通常比合併 CI 寬得多。" },
    en: { q: "'Prediction intervals are usually narrower than the pooled CI.'", exp: "False. Prediction intervals account for between-study variation and predict the range for a new study — they're usually much wider than the pooled CI." },
    correct: false
  },

  // ── Category 2: Advanced (5 Qs) ──
  {
    id: "c5-081", category: 2, type: "true_false",
    zh: { q: "「方法學異質性和統計異質性是完全相同的概念。」", exp: "錯誤。方法學異質性指研究設計的差異（如偏誤風險不同），統計異質性指效應量的數值差異。前者是原因，後者是表現。" },
    en: { q: "'Methodological heterogeneity and statistical heterogeneity are the same concept.'", exp: "False. Methodological heterogeneity = differences in study design (e.g., varying bias risk). Statistical heterogeneity = variation in effect sizes. The former is a cause; the latter is a manifestation." },
    correct: false
  },
  {
    id: "c5-082", category: 2, type: "multi_select",
    zh: { q: "臨床異質性的來源包括？（選出所有正確答案）", opts: ["不同的病人族群", "不同的藥物劑量", "不同的統計軟體", "不同的追蹤時間"], exp: "病人族群、劑量、追蹤時間的差異都是臨床異質性的來源。使用不同統計軟體不是臨床異質性。" },
    en: { q: "Sources of clinical heterogeneity include? (Select ALL correct)", opts: ["Different patient populations", "Different drug doses", "Different statistical software", "Different follow-up durations"], exp: "Population, dose, and follow-up differences are clinical heterogeneity sources. Statistical software is not a clinical heterogeneity source." },
    correctAll: [0, 1, 3]
  },
  {
    id: "c5-083", category: 2, type: "spot_error",
    zh: {
      q: "找出以下異質性來源分析中的錯誤：",
      statements: [
      ...
      exp: "即使統計異質性低（I² 低），仍應考慮臨床和方法學差異。研究可能在概念上非常不同但碰巧效應量相似。"
    },
    en: {
      q: "Find the error in this heterogeneity source analysis:",
      statements: [
        "Clinical heterogeneity comes from differences in patients, interventions, outcome definitions.",
        "Methodological heterogeneity comes from differences in study design and bias risk.",
        "Statistical heterogeneity can be quantified using I² and Q.",
        "If statistical heterogeneity is low, clinical and methodological heterogeneity need not be considered."
      ],
      exp: "Even low statistical heterogeneity doesn't eliminate the need to consider clinical/methodological differences. Studies may be conceptually different but happen to have similar effects."
    },
    correct: 3
  },
  {
    id: "c5-084", category: 2, type: "ordering",
    zh: {
      q: "將異質性從「最淺層」到「最深層」排列：",
      items: ["統計異質性（數字上的差異）", "方法學異質性（研究設計的差異）", "臨床異質性（臨床設定的差異）", "理論異質性（基礎機制的差異）"],
      exp: "統計異質性是表面現象→由方法學差異→或臨床差異→或更深層的理論機制差異所造成。"
    },
    en: {
      q: "Arrange heterogeneity from 'most superficial' to 'deepest level':",
      items: ["Statistical heterogeneity (numerical differences)", "Methodological heterogeneity (study design differences)", "Clinical heterogeneity (clinical setting differences)", "Theoretical heterogeneity (underlying mechanism differences)"],
      exp: "Statistical heterogeneity is the surface manifestation → caused by methodological → clinical → or deeper theoretical mechanism differences."
    },
    correctOrder: [0, 1, 2, 3]
  },
  {
  ...
  },
  {
    ...
    en: {
      ...
      statements: [
        "We performed subgroup analysis by dose level.",
        "High-dose OR = 0.5, low-dose OR = 0.9.",
        "Because effects look different, we confirm dose is the cause of heterogeneity.",
        "Test for subgroup differences: p = 0.08."
      ],
      exp: "p = 0.08 means the subgroup difference is NOT statistically significant. You can't confirm causation just because effects 'look different' — formal interaction testing is required."
    },
    correct: 2
  },
  {
    ...
    en: {
      ...
      items: ["Visual inspection of forest plot CI overlap", "Calculate I² and Q statistics", "Conduct pre-specified subgroup analyses", "Perform meta-regression"],
      exp: "Visual inspection → quantification (I²/Q) → subgroup analysis → meta-regression. From simple to complex, progressively deeper exploration."
    },
    correctOrder: [0, 1, 2, 3]
  },
  {
    id: "c5-090", category: 3, type: "true_false",
    zh: { q: "「統合迴歸可以同時考慮多個潛在的異質性來源。」", exp: "正確。統合迴歸類似多元迴歸，可以同時納入多個共變數（如劑量、年齡、追蹤時間）來探索異質性。" },
    en: { q: "'Meta-regression can simultaneously consider multiple potential sources of heterogeneity.'", exp: "True. Meta-regression is similar to multiple regression, allowing inclusion of several covariates (dose, age, follow-up) to explore heterogeneity simultaneously." },
    correct: true
  },

  // ── Category 4: Advanced (5 Qs) ──
  {
    id: "c5-091", category: 4, type: "true_false",
    zh: { q: "「漏斗圖不對稱一定是發表偏倚造成的。」", exp: "錯誤。不對稱也可能由小型研究效應、異質性、方法學品質差異等造成。發表偏倚只是可能原因之一。" },
    en: { q: "'Funnel plot asymmetry is always caused by publication bias.'", exp: "False. Asymmetry can also result from small-study effects, heterogeneity, methodological quality differences, etc. Publication bias is just one possible cause." },
    correct: false
  },
  {
    id: "c5-092", category: 4, type: "multi_select",
    zh: { q: "漏斗圖不對稱的可能原因？（選出所有正確答案）", opts: ["發表偏倚", "小型研究效應", "真實的異質性", "研究品質差異"], exp: "所有四個都是漏斗圖不對稱的可能原因。這就是為什麼不能僅憑漏斗圖就下結論是「發表偏倚」。" },
    en: { q: "Possible causes of funnel plot asymmetry? (Select ALL correct)", opts: ["Publication bias", "Small-study effects", "True heterogeneity", "Quality differences among studies"], exp: "All four are possible causes. This is why funnel asymmetry alone cannot be attributed solely to publication bias." },
    correctAll: [0, 1, 2, 3]
  },
  {
    id: "c5-093", category: 4, type: "spot_error",
    zh: {
      q: "找出以下發表偏倚評估中的錯誤：",
      statements: [
        "我們繪製了漏斗圖來評估發表偏倚。",
        "漏斗圖看起來基本對稱。",
        "因此我們確定不存在發表偏倚。",
        "我們也進行了 Egger's test 作為補充。"
      ],
      exp: "漏斗圖對稱不能「確定」不存在發表偏倚。只能說「沒有視覺證據顯示」發表偏倚。況且少於 10 個研究時漏斗圖判讀不可靠。"
    },
    en: {
      q: "Find the error in this publication bias assessment:",
      statements: [
        "We drew a funnel plot to assess publication bias.",
        "The funnel plot appeared roughly symmetrical.",
        "Therefore, we confirm no publication bias exists.",
        "We also performed Egger's test as supplementary analysis."
      ],
      exp: "A symmetrical funnel plot cannot 'confirm' no publication bias. You can only say 'no visual evidence of' bias. Also, funnel plots are unreliable with <10 studies."
    },
    correct: 2
  },
  {
    id: "c5-094", category: 4, type: "ordering",
    zh: {
      q: "將以下減少發表偏倚的策略從「預防」到「偵測」排列：",
      items: ["事先註冊 protocol（如 PROSPERO）", "搜尋灰色文獻和會議摘要", "繪製漏斗圖視覺檢查", "進行 Egger's test 統計檢定"],
      exp: "註冊（預防）→廣泛搜尋（預防+減少）→漏斗圖（偵測）→統計檢定（偵測）。預防優於偵測。"
    },
    en: {
      q: "Arrange from 'prevention' to 'detection' of publication bias:",
      items: ["Register protocol (e.g., PROSPERO)", "Search grey literature and conference abstracts", "Draw funnel plot for visual inspection", "Perform Egger's test"],
      exp: "Registration (prevention) → broad searching (prevention+reduction) → funnel plot (detection) → statistical test (detection). Prevention > detection."
    },
    correctOrder: [0, 1, 2, 3]
  },
  {
    id: "c5-095", category: 4, type: "true_false",
    zh: { q: "「至少需要 10 個研究，漏斗圖的判讀才比較可靠。」", exp: "正確。少於 10 個研究時，漏斗圖的形狀幾乎不可能可靠地判讀是否對稱。" },
    en: { q: "'At least 10 studies are needed for reliable funnel plot interpretation.'", exp: "True. With fewer than 10 studies, it's virtually impossible to reliably assess funnel plot symmetry." },
    correct: true
  },

  // ── Category 5: Advanced (5 Qs) ──
  {
    id: "c5-096", category: 5, type: "true_false",
    zh: { q: "「Egger's test p > 0.05 代表一定沒有發表偏倚。」", exp: "錯誤。p > 0.05 可能只是統計效力不足（特別是 <10 個研究時）。不能排除發表偏倚的存在。" },
    en: { q: "'Egger's test p > 0.05 means publication bias definitely doesn't exist.'", exp: "False. p > 0.05 may simply reflect insufficient statistical power (especially with <10 studies). It does not rule out publication bias." },
    correct: false
  },
  {
    id: "c5-097", category: 5, type: "multi_select",
    zh: { q: "修剪填補法的限制包括？（選出所有正確答案）", opts: ["假設不對稱完全由遺漏的研究造成", "填補的研究是虛構的，不是真實數據", "不能區分發表偏倚和其他不對稱原因", "結果永遠正確"], exp: "修剪填補法假設不對稱由缺失研究造成、填補虛構數據、無法區分偏倚類型。結果不是「永遠正確」。" },
    en: { q: "Limitations of trim-and-fill include? (Select ALL correct)", opts: ["Assumes asymmetry is entirely due to missing studies", "Imputed studies are hypothetical, not real data", "Cannot distinguish publication bias from other asymmetry causes", "Results are always correct"], exp: "Trim-and-fill assumes asymmetry = missing studies, imputes hypothetical data, can't distinguish bias types. Results are NOT always correct." },
    correctAll: [0, 1, 2]
  },
  {
    id: "c5-098", category: 5, type: "spot_error",
    zh: {
      q: "找出以下偏倚評估報告中的錯誤：",
      statements: [
        "我們共納入 6 個研究進行統合分析。",
        "漏斗圖顯示輕微不對稱。",
        "Egger's test p = 0.12，因此不存在發表偏倚。",
        "修剪填補法調整後效應量略為縮小。"
      ],
      exp: "6 個研究太少，Egger's test 統計效力不足。p = 0.12 只能說「未偵測到」，不能說「不存在」。且 <10 個研究時漏斗圖和 Egger's 都不太可靠。"
    },
    en: {
      q: "Find the error in this bias assessment report:",
      statements: [
        "We included 6 studies in the meta-analysis.",
        "The funnel plot showed slight asymmetry.",
        "Egger's test p = 0.12, so publication bias does not exist.",
        "Trim-and-fill adjusted effect was slightly smaller."
      ],
      exp: "With only 6 studies, Egger's test has insufficient power. p = 0.12 can only say 'not detected,' not 'does not exist.' Both funnel plots and Egger's are unreliable with <10 studies."
    },
    correct: 2
  },
  {
    id: "c5-099", category: 5, type: "ordering",
    zh: {
      q: "將以下發表偏倚評估方法按建議使用順序排列：",
      items: ["視覺檢查漏斗圖", "進行 Egger's test 統計檢定", "使用修剪填補法估計調整後效應", "綜合討論所有結果及其局限"],
      exp: "漏斗圖（視覺）→ Egger's（統計）→修剪填補（校正）→綜合討論。多方法並行，最後綜合判斷。"
    },
    en: {
      q: "Arrange publication bias assessment methods in recommended order:",
      items: ["Visual funnel plot inspection", "Egger's statistical test", "Trim-and-fill to estimate adjusted effect", "Comprehensive discussion of all results and limitations"],
      exp: "Funnel plot (visual) → Egger's (statistical) → trim-and-fill (adjustment) → comprehensive discussion. Multiple methods, then synthesize."
    },
    correctOrder: [0, 1, 2, 3]
  },
  {
    id: "c5-100", category: 5, type: "true_false",
    zh: { q: "「修剪填補法調整後效應量變小但仍顯著，可以增強對結論的信心。」", exp: "正確。如果考慮了可能的缺失研究後，結論方向和顯著性不變，表示結果對發表偏倚有一定的穩健性。" },
    en: { q: "'If the trim-and-fill adjusted effect is smaller but remains significant, this strengthens confidence in the conclusion.'", exp: "True. If the conclusion holds even after accounting for potentially missing studies, it suggests robustness against publication bias." },
    correct: true
  },

  // ── Category 6: Advanced (5 Qs) ──
  {
    id: "c5-101", category: 6, type: "true_false",
    zh: { q: "「PRISMA 2020 只是建議性的，不遵循也沒關係。」", exp: "雖然不是法律強制，但大多數期刊要求遵循 PRISMA。不遵循會降低報告的透明度和可信度，也可能導致退稿。" },
    en: { q: "'PRISMA 2020 is just a suggestion — not following it is fine.'", exp: "While not legally mandatory, most journals require PRISMA compliance. Not following it reduces transparency and credibility, and may lead to rejection." },
    correct: false
  },
  {
    id: "c5-102", category: 6, type: "multi_select",
    zh: { q: "GRADE 評估中降低證據等級的因素？（選出所有正確答案）", opts: ["偏誤風險高", "結果不精確", "證據直接且一致", "發表偏倚"], exp: "高偏誤風險、不精確性、發表偏倚都是降級因素。「直接且一致」的證據反而是維持高等級的正面因素。" },
    en: { q: "GRADE factors that DOWNGRADE evidence? (Select ALL correct)", opts: ["High risk of bias", "Imprecision", "Direct and consistent evidence", "Publication bias"], exp: "High bias risk, imprecision, publication bias are downgrading factors. 'Direct and consistent' evidence is a positive factor that maintains the grade." },
    correctAll: [0, 1, 3]
  },
  {
    id: "c5-103", category: 6, type: "spot_error",
    zh: {
      q: "找出以下統合分析結論中的錯誤：",
      statements: [
        "我們的統合分析顯示藥物 X 可降低住院率。",
        "合併 OR = 0.75 (95% CI: 0.60–0.94)，具統計顯著性。",
        "因此所有病人都應該使用藥物 X。",
        "建議臨床醫師在個別評估後考慮使用。"
      ],
      exp: "統合分析提供的是「平均」效應，不能推論「所有病人都應該」使用。需要考慮個別病人的特徵、禁忌症和偏好。"
    },
    en: {
      q: "Find the error in this meta-analysis conclusion:",
      statements: [
        "Our meta-analysis shows Drug X reduces hospitalization rates.",
        "Pooled OR = 0.75 (95% CI: 0.60–0.94), statistically significant.",
        "Therefore all patients should use Drug X.",
        "Clinicians should consider use after individual assessment."
      ],
      exp: "Meta-analysis provides an 'average' effect — you can't conclude 'all patients should' use it. Individual characteristics, contraindications, and preferences must be considered."
    },
    correct: 2
  },
  {
    id: "c5-104", category: 6, type: "ordering",
    zh: {
      q: "將統合分析的完整流程按正確順序排列：",
      items: ["提出問題 (PICO) 並註冊 protocol", "系統性搜尋文獻並篩選", "萃取數據並評估偏誤風險", "合併分析、評估異質性和發表偏倚", ],
      exp: "PICO + 註冊 → 搜尋篩選 → 萃取和品質評估 → 分析和報告。這就是 Courses 0-5 的完整學習旅程。"
    },
    en: {
      q: "Arrange the complete meta-analysis workflow in correct order:",
      items: ["Formulate question (PICO) and register protocol", "Systematic search and screening", "Data extraction and risk of bias assessment", "Pool analysis, assess heterogeneity and publication bias"],
      exp: "PICO + registration → search & screen → extraction & quality → analysis & reporting. This is the complete Courses 0-5 journey."
    },
    correctOrder: [0, 1, 2, 3]
  },
  {
    id: "c5-105", category: 6, type: "true_false",
    zh: { q: "「統合分析的品質取決於輸入數據的品質——垃圾進、垃圾出。」", exp: "正確。這是 GIGO 原則。無論統計方法多精巧，如果納入的研究品質差或有偏誤，合併結果也不可靠。" },
    en: { q: "'Meta-analysis quality depends on input data quality — garbage in, garbage out.'", exp: "True. The GIGO principle applies. No matter how sophisticated the statistics, if included studies are poor quality or biased, pooled results will be unreliable." },
    correct: true
  },
];
